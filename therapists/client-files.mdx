...
Each row carries the next session, when you last saw them, how much of a funded plan is left, and any risk flag. Three cards sit above the list — **Active clients**, **Sessions delivered** and **Risk flags**.
...
The header carries their name, status and any risk flag, with **Message** and **New note** beside it, then **Next session**, **Last seen**, and either sessions held or plan use. Five tabs sit under it: **Overview**, **Notes**, **Measures**, **Documents**, and **About**.

<Frame caption="**Overview** opens on the last note, goals and contact details">
  <img src="/images/therapist-client-file.webp" width="2880" height="1800" style={{ width: 1440 }} alt="A client file for Maya Okonkwo marked Active and Elevated, with Message and New note buttons, the next session, last seen date and 16 sessions held, tabs for Overview, Notes, Measures, Documents and About, a Last note card, two goals at 40 and 60 per cent, a risk and safety panel offering Write a safety plan, and a contact panel with email, mobile and GP" />
</Frame>

### Overview

The last note, the goals, the risk and safety panel, and the contact panel. The client's own brief lives under **About**.
...
<Frame caption="Each section has a **Tidy wording** option">
  <img src="/images/therapist-client-notes.webp" width="2880" height="1800" style={{ width: 1440 }} alt="The Notes tab of a client file showing 15 notes, Templates and New note buttons, and an expanded Individual therapy note dated Tuesday 1 September with written Presentation, Intervention and Plan sections" />
</Frame>

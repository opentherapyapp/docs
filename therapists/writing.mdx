...
<Frame caption="The Open Therapy blog, where a reader can filter to a topic or to the latest writing">
  <img src="/images/blog.webp" width="2880" height="1800" style={{ width: 1440 }} alt="The public Open Therapy blog headed News and guides, with a line saying it is written by the Open Therapy community and the therapists you can book here, and a lead article titled The inbox is not the problem, bylined Nicholas Carlton, dated 20 August 2026, with a two-minute read time" />
</Frame>

---
title: "Care types"
description: "The sixteen care categories, and which five you can book today."
keywords: ["care types", "psychology", "counselling", "disciplines", "coming soon", "waitlist"]
---

Open Therapy sorts practitioners into **sixteen care types**, each a family of professions rather than a single job title — Psychology holds both psychologists and clinical psychologists, Disability support holds three roles.

**Five are open for bookings: Psychology, Counselling, Social Workers, Mental Health Support Workers, and Art & Music Therapy.** The other eleven have a page and practitioners behind them, but can't be booked yet.
